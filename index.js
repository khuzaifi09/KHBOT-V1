...
//
const BotName = 'BOT KHUZAIFI'; // Nama Bot Whatsapp
const instagramlu = 'Masih Dalam Pertumbuhan bund :v'; // Nama Instagramlu cok
const whatsapplu = '0856-5587-2206'; // Nomor whatsapplu cok
const kapanbotaktif = '14 Jam'; // Kapan bot lu aktif
const grupch1 = 'Blom Di Buat Bund'; // OFFICIAL GRUP LU 1
const grupch2 = 'Blom Di Buat Bund'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
